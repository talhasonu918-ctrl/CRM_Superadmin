  ...
  return [
    {
      ...
      size: 200,
      cell: ({ getValue }) => (
        <span className={`font-bold text-xs sm:text-sm block truncate max-w-[120px] sm:max-w-none ${theme.text.primary}`} title={getValue() as string}>
          {getValue() as string}
        </span>
      ),
    },
    {
      ...
      size: 220,
      cell: ({ getValue }) => (
        <span className={`text-xs sm:text-sm block truncate max-w-[120px] sm:max-w-none ${theme.text.secondary}`} title={getValue() as string}>
          {getValue() as string}
        </span>
      ),
    },
