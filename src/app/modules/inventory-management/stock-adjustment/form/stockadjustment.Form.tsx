  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="flex flex-col lg:flex-row h-full overflow-hidden">
          ...
          <div className="flex items-center justify-between p-4 rounded-2xl bg-primary/5 border border-primary/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className={`text-base font-black ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>{formData.adjustmentNo}</h3>
              </div>
            </div>
            <div className="text-right">
              ...
              <input 
                ...
                className={`bg-transparent text-sm font-bold outline-none text-right ${isDarkMode ? 'text-white' : 'text-slate-900'}`}
              />
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl">
                <button
                  ...
                  className={`flex-1 py-3 rounded-lg flex items-center justify-center gap-2 text-sm font-black transition-all ${
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl border text-sm font-black outline-none transition-all ${
        ...
        <div className={`w-full lg:w-72 p-6 border-t lg:border-t-0 lg:border-l flex flex-col justify-between ${isDarkMode ? 'bg-slate-900/50 border-slate-800' : 'bg-slate-50 border-slate-100'}`}>
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-slate-800">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-black text-primary uppercase tracking-wider">Final Stock:</span>
            ...
            <div className={`p-4 rounded-xl text-[11px] leading-relaxed flex gap-3 ${isDarkMode ? 'bg-slate-800 text-slate-400' : 'bg-white text-slate-500 shadow-sm border border-slate-100'}`}>
          ...
          <div className="flex flex-col gap-2 mt-8 lg:mt-0">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-primary text-white text-xs font-black shadow-lg shadow-primary/20 hover:opacity-90 active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2 transition-all"
            >
